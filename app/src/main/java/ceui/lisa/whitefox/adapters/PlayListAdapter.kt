...
class PlayListAdapter(values: List<PlaylistBean>) : BaseAdapter<PlaylistBean, RecyPlaylistItemBinding>(values) {

    override fun layout(): Int {
        return R.layout.recy_playlist_item
    }

    override fun onBindViewHolder(holder: VH<RecyPlaylistItemBinding>, position: Int) {
